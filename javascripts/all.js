...
(function() {
  var fixedHeader, getCircleLength;

  fixedHeader = function() {
    var currentScroll;
    currentScroll = window.pageYOffset || document.documentElement.scrollTo;
    if (currentScroll >= 1) {
  ...
  $(function() {
    var $path, button, certificationsSlider, linkBtns, mainSwiper, menu, mySwiper, pathLength;
    ...
    linkBtns.each(function() {
      return $(this).on('click', function() {
        ...
        return classie.remove(button, 'opened');
      });
    });
    button.onclick = function(e) {
      e.preventDefault();
      classie.toggle(this, 'opened');
      return classie.toggle(menu, 'opened');
    };
    mySwiper = new Swiper('.facts-slider', {
      direction: 'vertical',
      loop: false,
    ...
    certificationsSlider = new Swiper('.certifications-slider', {
      pagination: '.certifications-swiper-pagination',
      ...
      paginationBulletRender: function(swiper, index, className) {
        var names;
        names = [];
        $('.certifications-slider  .swiper-slide').each(function(i) {
          return names.push($(this).data('name'));
        });
    ...
    $path = $('.circle-chart');
    pathLength = getCircleLength($path);
    $path.css({
    ...
    mainSwiper = new Swiper('.main-slider', {
      ...
      onProgress: function(swiper, progress) {
        var rotating;
        rotating = '-' + (progress * 360) + 'deg';
        $path.velocity({
          'stroke-dashoffset': pathLength * (1 - progress),
          easing: 'easeInOutSine',
          duration: 2000
        });
        return $('.figure-outer').velocity({
          rotateZ: rotating,
          easing: 'easeInOutSine',
          duration: 2000
        });
